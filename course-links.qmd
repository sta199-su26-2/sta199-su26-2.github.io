...
+----------------------------+-----------------------------------------------------------------------------+-----------+
| Course GitHub organization | 🔗 on [GitHub](https://github.com/sta199-su26-2)                            |           |
+----------------------------+-----------------------------------------------------------------------------+-----------+
| RStudio containers         | 🔗 on [Duke Container Manager](https://cmgr.oit.duke.edu/containers)        |           |
+----------------------------+-----------------------------------------------------------------------------+-----------+
| Ed Discussion              | 🔗 on [Canvas](https://edstem.org/us/courses/100036/discussion/)              |           |
+----------------------------+-----------------------------------------------------------------------------+-----------+
| Gradescope                 | 🔗 on [Canvas](https://www.gradescope.com/courses/1331287)                  |           |
+----------------------------+-----------------------------------------------------------------------------+-----------+
