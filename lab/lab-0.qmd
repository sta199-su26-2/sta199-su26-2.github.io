...
description: "End of lab on Jun 29"
categories: "Lab"
execute:
  eval: false
---
...
usethis::use_git_config(
  user.name = "Josh Lim",
  user.email = "jlimlightningblade@gmail.com"
)
```
...
-   Go to the repository for **lab-0** in the course GitHub organization: <https://github.com/sta199-su26-2/lab-0>.
...
Fill out the course "Getting to know you" [survey](https://canvas.duke.edu/courses/78820/quizzes/49069) on Canvas.
