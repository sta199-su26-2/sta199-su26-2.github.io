...
categories: Lab
description: "Due to Gradescope by Sun. Jul 19 12:00 PM"
draft: false
---
...
- Go to the course organization at [github.com/sta199-su26-2](https://github.com/sta199-su26-2) organization on GitHub. Click on the repo with the prefix **lab-3**. It contains the starter documents you need to complete the homework.
...
- Scatter plot of `gdp_percap` (y-axis) vs. `life_exp` (x-axis)

- Scatter plot of `gdp_percap_log` (y-axis) vs `life_exp` (x-axis), where `gdp_percap_log` is a new variable you add to the data set by taking the natural log of `gdp_percap`.
