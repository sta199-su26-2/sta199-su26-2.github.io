...
-   Midterm this Thursday!
    ...
    -   Practice questions and solutions for both the multiple choice & free response of the exam posted
    
    - Ways to study? Questions above, make your cheat sheet independently, lab 3. 
...
-   Project work begins this week!

    -   Friday's lecture will function as a lab meeting.  

    -   You will receive your team assignments (2 groups of 3, 2 groups of 4) this Friday
...
-   Remember in order to get credit for a day's AE, you must be both present AND commit push at least once.

- 80% of AEs starting from second week to get full credit.
...
For example, recall we worked with *durham-climate.csv* in AE08.
...
## Why not include `ae-joshlim789`? {.smaller}
